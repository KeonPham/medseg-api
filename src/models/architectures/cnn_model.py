...
class CNNLungSeg(nn.Module):
    """CNN-only lung segmentation model.

    Architecture:
        - Encoder: ResNet-18 (pretrained on ImageNet)
        - Decoder: U-Net style progressive upsampling with skip connections
    ...
    def __init__(self, in_channels: int = 3, out_channels: int = 1) -> None:
        """Initialize the CNN lung segmentation model.
        ...
        logger.info("CNNLungSeg initialized (stub — architecture not yet ported)")
